...
Source0  : https://files.pythonhosted.org/packages/d6/3d/d51e8c691d24e08cbf5b1924a4f950c492d44f7e3ccbacf362f1de04ce2b/google-resumable-media-2.7.1.tar.gz
...
%prep
%setup -q -n google-resumable-media-2.7.1
cd %{_builddir}/google-resumable-media-2.7.1
pushd ..
cp -a google-resumable-media-2.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718228965
